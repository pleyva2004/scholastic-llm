...
\label{tab:sources}
\small
\begin{tabular}{p{4.6cm} p{3.2cm} p{2.0cm} p{3.4cm}}
\toprule
\textbf{Work} & \textbf{Translation} & \textbf{Status} & \textbf{Source URL} \\
\midrule
Catechism of the Catholic Church (1992) & USCCB / Libreria Editrice Vaticana &
Copyrighted (fair-use research posture) & vatican.va \\
Summa Theologica & Fr.~Laurence Shapcote, 1920 & Public domain (US) &
newadvent.org \\
Augustine, Confessions & E.B.~Pusey & Public domain & newadvent.org \\
Augustine, City of God & Marcus Dods & Public domain & newadvent.org \\
\bottomrule
\end{tabular}
\end{table}
